...
Canabalt = function(container, options) {
  ...
  //this.audioStep1 = new Audio(Canabalt.AUDIO_STEP);
  //this.audioStep2 = new Audio(Canabalt.AUDIO_STEP);
...
Canabalt.prototype.cycle = function() {
  ...
  if (this.airborne) {
    ...
    if (this.runnerRunAnimationDistance > Canabalt.RUNNER_RUNNING_CHANGE_FRAME_DISTANCE) {
      ...
      ++this.runnerFrame;
      /*
      if (this.runnerFrame % 16 == 3) {
        this.audioStep1.play();
      } else if (this.runnerFrame % 16 == 11) {
        this.audioStep2.play();
      }
      */
    }
  }
